...
{: .box-note}
**User-friendly summary:** We don't use any cookies or trackers on this site. This website is hosted by GitHub Pages, which may log your IP address or other details provided by your browser, for security purposes. If you click on a link or follow a QR code (such as to the WhatsApp group), the privacy policy of that website or app applies.
...
Norbert-Wollheim-Platz 1, Goethe Universität, FB 06 Ev. Theologie
...
## **15. Data protection provisions about the application and use of GitHub Pages**
...
Further information and the applicable data protection provisions can be found at [https://pages.github.com/.](https://pages.github.com/.)

Diese Datenschutzerklärung wurde unter Verwendung eines Generators erstellt, der mit Unterstützung von [Experten für Wettbewerbsrecht](https://www.wbs.legal/), [zertifizierten Datenschutzauditoren](https://dg-datenschutz.de/) und der [ISO 22301 Zertifizierungsstelle](https://cert-authority.com/) entwickelt wurde.
